Feature: Welcome Scenario End to End Flow 
  Testing the Welcome Scenario End to End Flow from User Entry page to Password Page

@WelcomeEndtoEnd 
Scenario: Welcome Scenario End to End Flow   
